...
public class Render2DUtils implements IMinecraft {
    ...
    protected static final TimerUtils timer = new TimerUtils();
    ...
    public static float[] getOnScreen2DHitBox(Entity e, int width, int height) {
        ...
        for (Vec3d vec : corners) {
            final GLUPUtils.Projection projection = GLUPUtils.getInstance().project(pos.x + vec.x /*- Minecraft.getMinecraft().getRenderManager().viewerPosX*/, pos.y + vec.y /*- Minecraft.getMinecraft().getRenderManager().viewerPosY*/, pos.z + vec.z /*- Minecraft.getMinecraft().getRenderManager().viewerPosZ*/, GLUPUtils.ClampMode.ORTHOGONAL, true);
